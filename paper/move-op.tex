...
Moreover, these results are \emph{strong} in the sense that they apply to unbounded executions and an arbitrary number of replicas: an inherent advantage of using proof rather than model checking.
