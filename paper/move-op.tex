...
\begin{IEEEkeywords}
Conflict-free Replicated Data Types (CRDTs), formal verification, distributed filesystems
\end{IEEEkeywords}}
\maketitle
...
\IEEEPARstart{M}{any} data management applications use a tree-structured or hierarchical data model.
