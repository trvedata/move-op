...
If \isa{do\_op} left the tree unchanged (line 29), we immediately have a contradiction.
...
However, in that case, the predicate \isa{ancestor tree1 c newp} on line 29 would have been true, which contradicts the earlier assumption.
...
Assume $\isa{t1} < \isa{t2}$ without loss of generality.
