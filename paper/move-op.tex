...
Isabelle/HOL's can extract executable Haskell, OCaml, Scala, and Standard ML code from HOL definitions using a code generation mechanism.
...
Because of these problems, we produce 
