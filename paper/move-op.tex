...
We adopt the convention that any definition using hash-maps will be referred to as an ``efficient'' definition, and any definition making use of HOL's set type will be referred to as an ``abstract'' definition, for the sake of clarity.
