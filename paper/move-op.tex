...
When a replica generates an operation, it immediately applies that operation to its local state, and then asynchronously sends the operation to the other two replicas via gRPC requests.
