...
\begin{itemize}
    \item The \textbf{filesystem} on most operating systems is organised as a tree: folders or directories are branch nodes, and files are leaf nodes.
        ...
        Strictly speaking, filesystems that support hardlinks form a DAG, but we will focus on trees for now and show in \S\ref{sec:hardlinks} how to add support for links.
