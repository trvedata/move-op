...
As mentioned in Section~\ref{sec:intro}, the work presented in this paper is especially interesting due to ubiquity of a tree-structured data model.
In future work we hope to build novel peer-to-peer distributed systems, such as a distributed file-system, that make essential use of our algorithm.
