...
The operator \isa{{\isasymexists}!x} means ``there exists a unique value \isa{x} such that\dots'', while \isa{THE x}\dots means ``\emph{choose} the unique value \isa{x} such that\ldots''.
